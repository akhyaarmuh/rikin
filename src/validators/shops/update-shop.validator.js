...
export default Joi.object().keys({
  ...
  foot_note: Joi.string()
    ...
    .messages({
      'any.required': 'Pesan nota wajib diisi',
      'string.min': 'Pesan nota harus memiliki setidaknya 2 karakter',
      'string.max': 'Pesan nota tidak boleh lebih dari 125 karakter',
      'string.pattern.base': 'Pesan nota hanya boleh terdiri dari huruf dan angka',
    }),
  pole_note: Joi.string()
    .trim()
    .strict()
    .required()
    .allow('')
    ...
    .pattern(/^[a-zA-Z0-9\s-,.|]*$/)
    .messages({
      'any.required': 'Pole display wajib diisi',
      'string.min': 'Pole display harus memiliki setidaknya 2 karakter',
      'string.max': 'Pole display tidak boleh lebih dari 125 karakter',
      'string.pattern.base': 'Pole display hanya boleh terdiri dari huruf dan angka',
    }),
});
