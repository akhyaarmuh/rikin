...
const idFormUpdate = 'update-customer-form';
const idModalsUpdate = 'update-customer-modals';
...
const Customers = () => {
  ...
  const [dataSelected, setDataSelected] = useState<Customer>(initialDataSelected);
  ...
  const showModalsUpdate = useCallback((data: Customer) => {
